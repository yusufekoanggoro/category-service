...
func (c *categoryServiceClient) SaveCategory(ctx context.Context, in *SaveCategoryRequest, opts ...grpc.CallOption) (*SaveCategoryResponse, error) {
...
func (UnimplementedCategoryServiceServer) SaveCategory(context.Context, *SaveCategoryRequest) (*SaveCategoryResponse, error) {
